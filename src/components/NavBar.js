...
const NavBar = () => {
  ...
  return (
    ...
    <div className='flex h-20 w-full justify-between pt-4 fixed z-50'>
      ...
      <Link className='flex border text-white border-yellow-400 hover:border-lime-200 hover:border-2 shadow-2xl rounded-3xl h-10 items-center p-2	gap-2' to='/about'><img src={About} className="h-5 w-5"></img> <div>About</div></Link>
      <Link className='flex border text-white border-yellow-400 hover:border-lime-200 hover:border-2 shadow-2xl rounded-3xl h-10 items-center p-2	gap-2' to='/projects'><img src={Project} className="h-5 w-5"></img> <div>Projects</div></Link>
      <Link className='flex border text-white border-yellow-400 hover:border-lime-200 hover:border-2 shadow-2xl rounded-3xl h-10 items-center p-2	gap-2' to='/resumes'><img src={Resumes} className="h-5 w-5"></img> <div>Resumes</div></Link>
